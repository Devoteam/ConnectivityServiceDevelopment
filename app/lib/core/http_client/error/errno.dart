...
class ErrorCodes {
  ...
  ///Network is down
  // ignore: non_constant_identifier_names
  static int get ENETDOWN => _platform((_Codes codes) => codes.enetdown);

  ///Network is unreachable
  // ignore: non_constant_identifier_names
  static int get ENETUNREACH => _platform((_Codes codes) => codes.enetunreach);

  ///Connection refused
  // ignore: non_constant_identifier_names
  static int get ECONNREFUSED => _platform((_Codes codes) => codes.econnrefused);

  static int _platform(int Function(_Codes codes) getCode) {
    final codes = _platforms[Platform.operatingSystem] ?? _platforms['linux']!;
